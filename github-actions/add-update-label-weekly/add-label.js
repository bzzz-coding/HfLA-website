...
threeDayCutoffTime.setMinutes(threeDayCutoffTime.getMinutes() - updatedByDays)
const sevenDayCutoffTime = new Date()
sevenDayCutoffTime.setMinutes(sevenDayCutoffTime.getMinutes() - commentByDays)
const fourteenDayCutoffTime = new Date()
fourteenDayCutoffTime.setMinutes(fourteenDayCutoffTime.getMinutes() - inactiveUpdatedByDays)
